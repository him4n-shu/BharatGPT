        ...
        {user && (
          ...
          >
            ...
            <div className="text-center mb-8">
              <div className="w-24 h-24 bg-gradient-to-r from-saffron to-green-700 rounded-full flex items-center justify-center text-white text-3xl font-bold mx-auto mb-4">
            ...
            <div className="space-y-6">
              ...
              <div className="border-b border-gray-200 pb-4">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">Membership Details</h3>
                <div>
            ...
            <div className="mt-8 flex flex-wrap gap-4 justify-center">
              <Link 
                href="/" 
                className="px-6 py-2 bg-gray-100 text-gray-800 rounded-lg hover:bg-gray-200 transition-all font-medium"
              >
                Back to Home
              </Link>
              <button 
